...
function App() {
      ...
      <div className="app">
        <div className="connect-screen">
          ...
          <p className="subtitle" style={{ marginTop: 16, fontSize: 12 }}>
            No MetaMask? Use Demo Mode to explore the full interface.
          </p>
        </div>
    ...
    return (
      <div className="app">
        <div className="header">
          <h1>EtherRealms {demoMode && <span style={{ fontSize: 12, color: 'var(--accent-yellow)' }}>(DEMO)</span>}</h1>
        ...
        <div className="mint-screen">
          ...
          <p>Mint a unique character NFT to enter the world of EtherRealms. {demoMode ? '' : 'Cost: 0.01 ETH'}</p>
          <input
  ...
  return (
    <div className="app">
      <div className="header">
        <h1>EtherRealms {demoMode ? <span style={{ fontSize: 12, color: 'var(--accent-yellow)' }}>(DEMO)</span> : <span>PoC</span>}</h1>
        <div className="wallet-info">
        ...
        <div>
          ...
          {activeTab === 'guild' && (
            <GuildPanel
              ...
              showNotification={showNotification}
              demoMode={demoMode}
              demoGuild={DEMO_GUILD}
            />
          )}
          {activeTab === 'leaderboard' && (
            <Leaderboard contracts={contracts} demoMode={demoMode} demoLeaders={DEMO_LEADERS} />
          )}
        </div>

        {/* Right: World Events */}
        <div>
          <WorldEvents contracts={contracts} demoMode={demoMode} demoEvents={DEMO_EVENTS} />
        </div>
      </div>
